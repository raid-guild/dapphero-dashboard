...
const Login: React.FC<any> = ({ loginError, uploadWallet }) => {
  return (
    <>
      ...
      <LoginContainer>
        <H2 color={colors.green} style={{ fontWeight: 600 }}>
          Upload a Wallet to Use App
        </H2>
        ...
        <P1>
          ...
          to learn how to get Arweave wallet.
        </P1>
        <br />
        <br />
        ...
        <br />
        <P1>
          DappHero Community is a simple low-code/no-code tool that lets you easily connect blockchain to your website,
          small business, portfolio, online store, blog, and much more!
        </P1>
        <br />
        <P1>
          <a
        ...
        <br />
        <P1>
          Arweave is a new type of storage that backs data with sustainable and perpetual endowments, allowing users and
          developers to truly store data forever – for the very first time.
        </P1>
        <br />
        <P1>
          On top of the Arweave network lives the permaweb: a global, community-owned web that anyone can contribute to
          or get paid to maintain.
        </P1>
        <br />
        <P1>
          <a
