...
const AddProject: React.FC<any> = ({
  ...
  const handleOnChange = (e: any) => {
    ...
    if (e.target.id === 'network') {
      ...
      const el = document.getElementById('contract') as HTMLInputElement;
      el.value = '';
      setNewContract('');
    }
  ...
  const onCopy = () => {
    const copyText = document.getElementById('script') as HTMLInputElement;
    ...
    <Main id="top" background={colors.grey}>
      <Card>
        ...
        <CardContainer>
          ...
          <Input id="name" onChange={handleOnChange} required value={newProject.name} />
          <Label htmlFor="description">Description:</Label>
          <TextArea id="description" onChange={handleOnChange} required value={newProject.description} />
        </CardContainer>
      </Card>
      ...
      <Card>
        ...
        <CardContainer>
          <P1 color={colors.grey2}>
            Select a network for your project, followed by one or more smart contracts deployed on that network.
          </P1>
          <br />
          <Label htmlFor="network">Select a project Network:</Label>
          <Select
            disabled={newProject.isLocked || pendingSave || pendingDelete}
            defaultValue={newProject.network}
          ...
          <P2 style={{ marginTop: '-2rem' }} color={colors.grey2}>
            A project can have only one network.
          </P2>
          <br />
          <br />
          ...
          <br />
          <ProjectContractsTable contractList={contractList} onRemoveContract={onRemoveContract} />
          <br />
          <br />
          <br />
      ...
      <Card>
        ...
        {isNew ? (
          <CardContainer>
            <P1 color={colors.grey2}>
              Save project to get script tag.{' '}
              <a
      ...
      <Card>
        ...
        <CardContainer>
          <P1 color={colors.grey2}>
            Pause the DappHero engine on your site, or prevent accidental project deletion.{' '}
            <a
              href={'https://docs.dapphero.io/'}
              style={{ textDecoration: 'none', color: colors.green }}
              target="_blank"
      ...
      <ButtonsContainer2>
        ...
        {!isNew && !newProject.isPaused && (
          <ButtonAction1 disabled={pendingSave || pendingDelete} color={colors.red} onClick={onDeleteProject}>
